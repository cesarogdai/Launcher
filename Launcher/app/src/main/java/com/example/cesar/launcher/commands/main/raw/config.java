    ...
    private enum Param implements com.example.cesar.launcher.commands.main.Param{
        ...
        ls {
            ...
            public String onNotArgEnough(ExecutePack pack, int n){
                ...
                for(XMLPrefsManafe.XMLPrefsRoot element : XMLPrefsManager.XMLPrefsRoot.vales()){
                    ss.add(element.path);
        ...
        fontsize {
            ...
            public String exec(ExecutePack pack){
                ...
                parent.write(Ui.input_outpt_size, String.valueOf(size));
            ...
            public String exec(ExecutePack pack){
                ...
                if(!file.getName().endsWith(".xml")){
                    ...
                    if(Tuils.fontPath != null){
                        Fle font = new File(Tuils.fontPath);
