...
import com.example.cesar.launcher.managers.xml.options.Reply;
...
import static com.example.cesar.launcher.tuils.LongClickableSpan.set;
...
//                Actually I assume that there's only one action
    ...
    public static String bind(String pkg) {
        return set(new File(Tuils.getFolder(), PATH), pkg, new String[] {ID_ATTRIBUTE}, new String[] {String.valueOf(nextUsableId)});
    }
